  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label class="col-form-label">Jumlah Dibayar : Rp {{ number_format($paid_amount, 0, ',', '.') }}</label>
          </div>
          ...
          <div class="form-group">
            ...
            @endphp
            <label class="col-form-label">Jumlah Tersisa : Rp {{ number_format($RemaningAmount, 0, ',', '.') }}</label>
          </div>
